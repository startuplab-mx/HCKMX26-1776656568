...
print("="*70)
print("EXPERIMENTO 2: SIN STOPWORDS (REGRESIÓN + SIGNO)")
print("="*70)
print("Configuración:")
print("  - Normalización: Sin stopwords")
...
# =========================
print("\n1. Cargando dataset...")
with open('pkl/no_stopwords_binary.pkl', 'rb') as f:
    data = pickle.load(f)
...
for i in range(10):
    print(f"Real: {y_test[i]:6.2f} | Pred: {y_pred[i]}")
...
# CONFIG
BEST_NORMALIZATION = 'stemming_no_stopwords'
BEST_VECTORIZATION = 'frequency'

print("="*70)
print("EXPERIMENTO 7: REGRESIÓN (ANTES NAIVE BAYES)")
print("="*70)
print("Configuración:")
...
# =========================
print("\n1. Cargando dataset...")
dataset_file = f'datasets/{BEST_NORMALIZATION}_{BEST_VECTORIZATION}.pkl'
...
print(f"Accuracy por signo: {acc_sign:.4f}")
...
with open('./results/results_exp07_regression.pkl', 'wb') as f:
    pickle.dump(results, f)

print("\n✓ Guardado en results_exp07_regression.pkl")
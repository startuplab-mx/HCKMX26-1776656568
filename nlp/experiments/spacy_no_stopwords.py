...
print("="*70)
print("EXPERIMENTO 18: SPACY + SIN STOPWORDS (REGRESIÓN + SIGNO)")
print("="*70)
print("Configuración:")
print("  - Normalización: Lematización SPACY + Sin stopwords")
print("  - Vectorización: Binaria")
print("  - Algoritmo: Ridge Regression")
print("="*70)
...
# =========================
print("\n1. Cargando dataset...")
with open('pkl/spacy_no_stopwords_binary.pkl', 'rb') as f:
    data = pickle.load(f)
...
print(f"\nMSE por fold: {-cv_results['test_neg_mean_squared_error']}")
print(f"✓ MSE promedio: {-cv_results['test_neg_mean_squared_error'].mean():.4f}")

print(f"\nR2 por fold: {cv_results['test_r2']}")
...
results = {
    'experiment': 'exp18_spacy_no_stopwords_regression',
    'normalization': 'spacy_no_stopwords',
...
with open('./results/results_exp18_regression.pkl', 'wb') as f:
    pickle.dump(results, f)

print("\n✓ Resultados guardados en: results/results_exp18_regression.pkl")
print("="*70)